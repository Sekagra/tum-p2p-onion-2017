 ...
 */
public class AuthLayerEncryptParsedMessage extends AuthLayerCryptParsedMessage {
    /**
     * Create a new AUTH LAYER ENCRYPT message.
     ...
     */
    protected AuthLayerEncryptParsedMessage(int requestId, short[] sessionIds, byte[] payload) {
    ...
    public MessageType getType() {
        return MessageType.AUTH_LAYER_ENCRYPT;
    }
}
