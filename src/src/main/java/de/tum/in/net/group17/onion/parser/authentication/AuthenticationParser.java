...
public interface AuthenticationParser extends Parser {
     ...
     *
     * @throws ParsingException If invalid parameters were provided or the host key is too long to fit into the message.
     */
     ...
     *
     * @throws ParsingException If invalid parameters were provided or the payload is too long to fit into the message.
     */
     ...
     *
     * @throws ParsingException If invalid parameters were provided, the number of session IDs is too large or
     ...
     *
     * @throws ParsingException If invalid parameters were provided or the payload is too long.
     */
     ...
     * @throws ParsingException If invalid parameters were provided or the payload is too long.
     */
    ParsedMessage buildCipherDecrypt(int requestId, short sessionId, byte[] payload) throws ParsingException;
