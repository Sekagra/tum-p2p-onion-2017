...
import de.tum.in.net.group17.onion.interfaces.authentication.AuthenticationInterfaceMock;
 ...
 */
public class OrchestratorUnitTestBaseInjector extends AbstractModule {
    @Override
    protected void configure() {
        // bind interfaces to other modules to their implementations
        bind(OnionInterface.class).to(OnionInterfaceImpl.class);
        bind(AuthenticationInterface.class).to(AuthenticationInterfaceMock.class);
        ...
        // bind LID interface to the current implementation
